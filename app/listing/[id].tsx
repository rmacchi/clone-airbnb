      ...
      headerRight: () => (
        <View style={styles.bar}>
          ...
          <TouchableOpacity
            style={styles.roundButton}
          >
            <Ionicons name="heart-outline" size={19} color={'#000'} style={{ marginTop: 2, marginLeft: 1 }} />
          </TouchableOpacity>
        </View>
      ),
      headerLeft: () => (
        <TouchableOpacity style={styles.roundButton} onPress={() => navigation.goBack()}>
          <Ionicons name="chevron-back" size={19} color={'#000'} />
        </TouchableOpacity>
      ),
    })
  }, [])
      ...
      <Animated.View style={defaultStyles.footer} entering={SlideInDown.delay(200)}>
        <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
          ...
          <TouchableOpacity style={[defaultStyles.btn, { paddingHorizontal: 40 }]}>
            <Text style={[defaultStyles.btnText, { fontSize: 14 }]}>Reserve</Text>
          </TouchableOpacity>
        </View>
      </Animated.View>
    </View>
